...
| Hash Crackers | 13 | MD5, SHA1, SHA256, SHA512, SHA3, BLAKE2, bcrypt, scrypt, Argon2, NTLM, MySQL |
...
> **IMPORTANTE:** Não abra o arquivo `index.html` diretamente! A interface precisa da API rodando.
...
### Decifrar com Algoritmo Específico
```
POST /api/decrypt
Body: {
 "ciphertext": "...",
...
**Desenvolvido com por Matheus Bueno para decifradores e entusiastas de criptografia.**
